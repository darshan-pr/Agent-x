...
- If the user replies with short confirmations like "yes/ok", infer intent from recent context and continue instead of repeating clarification prompts.
...
- Prefer editFile for creating/updating source files; avoid complex shell quoting (echo/python -c with multiline code).
